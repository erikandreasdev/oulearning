...
/**
 * Domain event emitted when a training request is approved by a manager.
 */
public record TrainingApproved(Id trainingId, ManagerReview review, Instant occurredAt) {

    public TrainingApproved {
