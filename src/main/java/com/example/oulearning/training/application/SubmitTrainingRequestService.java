...
public class SubmitTrainingRequestService implements SubmitTrainingRequestUseCase {
    ...
    public UUID execute(SubmitTrainingRequestCommand command) {
        ...
        final var requesterOrgCk = com.example.oulearning.organization.domain.employee.CorporateKey.of(command.requesterCorporateKey());
        ...
        for (final var assistantKeyStr : command.assistantCorporateKeys()) {
            final var assistantOrgCk = com.example.oulearning.organization.domain.employee.CorporateKey.of(assistantKeyStr);
