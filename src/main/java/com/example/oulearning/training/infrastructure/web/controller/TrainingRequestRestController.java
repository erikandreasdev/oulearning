package com.example.oulearning.training.infrastructure.web.controller;

import com.example.oulearning.training.application.port.in.command.ApproveTrainingRequestCommand;
import com.example.oulearning.training.application.port.in.usecase.ApproveTrainingRequestUseCase;
import com.example.oulearning.training.application.port.in.query.GetTrainingRequestQuery;
import com.example.oulearning.training.application.port.in.usecase.GetTrainingRequestUseCase;
import com.example.oulearning.training.application.port.in.query.GetTrainingRequestsQuery;
import com.example.oulearning.training.application.port.in.usecase.GetTrainingRequestsUseCase;
import com.example.oulearning.training.application.port.in.command.RejectTrainingRequestCommand;
import com.example.oulearning.training.application.port.in.usecase.RejectTrainingRequestUseCase;
...
import com.example.oulearning.training.infrastructure.web.request.ApproveTrainingRequest;
import com.example.oulearning.training.infrastructure.web.request.RejectTrainingRequest;
import com.example.oulearning.training.infrastructure.web.request.SubmitTrainingRequest;
import com.example.oulearning.training.infrastructure.web.response.TrainingRequestResponse;
