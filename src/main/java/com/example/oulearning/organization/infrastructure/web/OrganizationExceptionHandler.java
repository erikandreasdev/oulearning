...
class OrganizationExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({EmployeeNotFoundException.class, OrganizationalUnitNotFoundException.class})
    ProblemDetail handleNotFoundException(final RuntimeException ex) {
        return ProblemDetail.forStatusAndDetail(HttpStatus.NOT_FOUND, ex.getMessage());
    }

    @ExceptionHandler({EmployeeException.class, HierarchyException.class})
