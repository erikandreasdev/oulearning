...
- Naming: `should_<expected>_when_<condition>` or `@DisplayName`; structure given/when/then.
- Test data via object mothers/builders (`OrderMother.confirmedOrder()`), never duplicated setup.
