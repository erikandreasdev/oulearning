...
description: Apply when reviewing code, discussing design, or when the user asks whether a change fits DDD / Clean Architecture. Checklist for architectural review.
---
