...
1. Read `<context>/README.md` and `docs/glossary.md`. List the aggregate(s), value objects, and existing use cases involved. Confirm the terms with the user if anything is new.
